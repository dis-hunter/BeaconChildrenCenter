...
<head>
<link rel='stylesheet' href='styleSheets/BehaviourAssesment.css'>
</head>
...
perinatalHistoryLink.addEventListener('click', (event)=>{
    ...
    mainContent.innerHTML=`
    <head>
    <link rel='stylesheet' href='styleSheets/perinatalHistory.css'>
</head>
<body>
...
DevMilestonesLink.addEventListener('click', (event)=>{
    ...
    mainContent.innerHTML=`
    <head>
    <link rel='stylesheet' href='styleSheets/DevMilestones.css'>
</head>
<body>
...
familyAndSocial.addEventListener('click', (event)=>{
    ...
    mainContent.innerHTML=`
    <head>
    <link rel='stylesheet' href='styleSheets/FamilyAndSocial.css'>
</head>
<body>
...
pastMedicalHistory.addEventListener('click', (event)=>{
    ...
    mainContent.innerHTML=`
    <head>
    <link rel='stylesheet' href='styleSheets/pastMedicalHistory.css'>
</head>
<body>
...
Examination.addEventListener('click', (event)=>{
    ...
    mainContent.innerHTML=`
    <head>
    <link rel='stylesheet' href='styleSheets/Examination.css'>
</head>
<body>
...
carePlan.addEventListener('click', (event)=>{
    ...
    mainContent.innerHTML=`
    <head>
    <link rel='stylesheet' href='styleSheets/carePlan.css'>
</head>
<body>
...
devAssesment.addEventListener('click', (event)=>{
    ...
    mainContent.innerHTML=`
    <head>
    <link rel='stylesheet' href='styleSheets/devAssesment.css'>
</head>
<body>
...
triageExam.addEventListener('click', (event)=>{
    ...
    mainContent.innerHTML=`
    <head>
    <link rel='stylesheet' href='styleSheets/triageExam.css'>
</head>
<body>
