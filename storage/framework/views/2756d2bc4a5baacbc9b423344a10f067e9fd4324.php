...
} elseif ($_instance->childHasBeenRendered('1NXw8Oj')) {
    $componentId = $_instance->getRenderedChildComponentId('1NXw8Oj');
    $componentTag = $_instance->getRenderedChildComponentTagName('1NXw8Oj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1NXw8Oj');
} else {
    $response = \Livewire\Livewire::mount('global-search');
    $html = $response->html();
    $_instance->logRenderedChild('1NXw8Oj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div> 
<div class="ml-auto">
...
<?php /**PATH C:\Users\sharo\Desktop\Today\htdocs\BeaconChildrenCenter-4\resources\views/reception/header.blade.php ENDPATH**/ ?>