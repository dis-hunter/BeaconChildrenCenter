                ...
                <form id="therapy-form" class="space-y-4" onsubmit="handleSubmit(event)">
                    ...
                    <div class="tabs" data-default="goals">
                        ...
                        <div id="goals" class="tabs-content active space-y-4">
                            <?php $__currentLoopData = ['ADLs', 'IADLs', 'Motor Skills', 'Cognitive Skills', 'Social Skills']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
