...
} elseif ($_instance->childHasBeenRendered('W8WWbrj')) {
    $componentId = $_instance->getRenderedChildComponentId('W8WWbrj');
    $componentTag = $_instance->getRenderedChildComponentTagName('W8WWbrj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('W8WWbrj');
} else {
    $response = \Livewire\Livewire::mount('password-generator');
    $html = $response->html();
    $_instance->logRenderedChild('W8WWbrj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
