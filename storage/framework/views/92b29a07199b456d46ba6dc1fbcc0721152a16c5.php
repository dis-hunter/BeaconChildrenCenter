...
<head>
    ...
    <title>Physiotherapy Dashboard</title>
    <style>
        .sidebar {
            width: 200px;
...
<body class="m-0 font-sans bg-gray-50">
    ...
    <div class="fixed right-5 top-20 bg-white rounded-lg shadow-lg overflow-hidden" id="floatingMenu">
        ...
        <a href="#generalExam" class="block px-4 py-3 text-gray-700 border-b border-gray-100 transition-all duration-300 hover:bg-sky-50 hover:text-blue-600">Physiotherapy Assessment</a>
        <div id="generalExam"></div>
        <a href="#Examination" class="block px-4 py-3 text-gray-700 border-b border-gray-100 transition-all duration-300 hover:bg-sky-50 hover:text-blue-600">Physiotherapy Goals</a>
        <div id="Examination"></div>
        <a href="#devAssesment" class="block px-4 py-3 text-gray-700 border-b border-gray-100 transition-all duration-300 hover:bg-sky-50 hover:text-blue-600">Physiotherapy Session</a>
        <div id="devAssesment"></div>
        <a href="#diagnosis" class="block px-4 py-3 text-gray-700 border-b border-gray-100 transition-all duration-300 hover:bg-sky-50 hover:text-blue-600">Physiotherapy Individualized Plan</a>
...
</html><?php /**PATH C:\Users\sharo\Desktop\Today\htdocs\BeaconChildrenCenter-4\resources\views/therapists/physiotherapyDashboard.blade.php ENDPATH**/ ?>