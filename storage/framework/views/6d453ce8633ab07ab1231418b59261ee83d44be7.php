...
} elseif ($_instance->childHasBeenRendered('JA03PpE')) {
    $componentId = $_instance->getRenderedChildComponentId('JA03PpE');
    $componentTag = $_instance->getRenderedChildComponentTagName('JA03PpE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JA03PpE');
} else {
    $response = \Livewire\Livewire::mount('global-search');
    $html = $response->html();
    $_instance->logRenderedChild('JA03PpE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div> 
<div class="ml-auto">
...
<?php /**PATH C:\Users\User\Downloads\Beacon\BeaconChildrenCenter\resources\views/reception/header.blade.php ENDPATH**/ ?>