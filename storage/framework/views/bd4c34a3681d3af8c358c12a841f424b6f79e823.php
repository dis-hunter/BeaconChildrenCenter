...
} elseif ($_instance->childHasBeenRendered('YpC5ZTk')) {
    $componentId = $_instance->getRenderedChildComponentId('YpC5ZTk');
    $componentTag = $_instance->getRenderedChildComponentTagName('YpC5ZTk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YpC5ZTk');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('YpC5ZTk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Kk94hAM')) {
    $componentId = $_instance->getRenderedChildComponentId('Kk94hAM');
    $componentTag = $_instance->getRenderedChildComponentTagName('Kk94hAM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Kk94hAM');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('Kk94hAM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
