...
} elseif ($_instance->childHasBeenRendered('ejqVBJc')) {
    $componentId = $_instance->getRenderedChildComponentId('ejqVBJc');
    $componentTag = $_instance->getRenderedChildComponentTagName('ejqVBJc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ejqVBJc');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('ejqVBJc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH D:\github\BeaconChildrenCenter\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>