...
<body>
  ...
  <section id="dashboard" class="content-section">
      ...
      <section class="todays-revenue">
        ...
        <p>ksh : <?php echo e(number_format($todaysRevenue, 2)); ?></p>
      </section>
      ...
      <section class="staff-management">
            ...
            <table class="staff-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($staffMember->full_name); ?></td>
                        <td><?php echo e($staffMember->role); ?></td>
                        <td>
                            <?php if($staffMember->status === 'Available'): ?>
                                Available
                            <?php elseif($staffMember->status === 'On Leave'): ?>
                                On Leave
                            <?php else: ?>
                                Unknown
                            <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\BeaconChildrenCenter\resources\views/beaconAdmin.blade.php ENDPATH**/ ?>