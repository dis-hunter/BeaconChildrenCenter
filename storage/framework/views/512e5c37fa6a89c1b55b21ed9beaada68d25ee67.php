...
} elseif ($_instance->childHasBeenRendered('l3638399072-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3638399072-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3638399072-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3638399072-2');
} else {
    $response = \Livewire\Livewire::mount('add-child-modal',['parent'=>$parent]);
    $html = $response->html();
    $_instance->logRenderedChild('l3638399072-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH C:\Users\User\Hospital\BeaconChildrenCenter\resources\views/livewire/parent-crud.blade.php ENDPATH**/ ?>