...
} elseif ($_instance->childHasBeenRendered('7UqBQot')) {
    $componentId = $_instance->getRenderedChildComponentId('7UqBQot');
    $componentTag = $_instance->getRenderedChildComponentTagName('7UqBQot');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7UqBQot');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('7UqBQot', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\sharo\Downloads\Beacon's\BeaconChildrenCenter\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>