...
} elseif ($_instance->childHasBeenRendered('5llWtvg')) {
    $componentId = $_instance->getRenderedChildComponentId('5llWtvg');
    $componentTag = $_instance->getRenderedChildComponentTagName('5llWtvg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5llWtvg');
} else {
    $response = \Livewire\Livewire::mount('child-search-bar');
    $html = $response->html();
    $_instance->logRenderedChild('5llWtvg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
    ...
    <script src="<?php echo e(asset('js/add_cal.js')); ?>"></script>
    <script src="<?php echo e(asset('js/appointments.js')); ?>"></script>
    <script src="<?php echo e(asset('js/specialization.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\BeaconChildrenCenter\resources\views/drcal.blade.php ENDPATH**/ ?>