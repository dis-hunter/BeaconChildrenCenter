...
} elseif ($_instance->childHasBeenRendered('Y3rZ6E7')) {
    $componentId = $_instance->getRenderedChildComponentId('Y3rZ6E7');
    $componentTag = $_instance->getRenderedChildComponentTagName('Y3rZ6E7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Y3rZ6E7');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('Y3rZ6E7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
