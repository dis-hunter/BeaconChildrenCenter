    ...
    <div class="clock" id="clock"></div> 
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="<?php echo e(route('doctor.profile')); ?>">View Profile</a>
          <a href="#">Settings</a>
    ...
    <aside class="sidebar">
      <nav>
        <ul>
          ...
          <li><a href="<?php echo e(route('doctor.profile')); ?>"><i class="fas fa-user"></i> Profile</a></li>
...
<?php /**PATH D:\github\BeaconChildrenCenter\resources\views/doctorDash.blade.php ENDPATH**/ ?>