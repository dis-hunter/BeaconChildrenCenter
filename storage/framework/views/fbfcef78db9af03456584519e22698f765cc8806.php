...
} elseif ($_instance->childHasBeenRendered('l3825658480-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3825658480-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3825658480-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3825658480-2');
} else {
    $response = \Livewire\Livewire::mount('add-child-modal',['parent'=>$parent]);
    $html = $response->html();
    $_instance->logRenderedChild('l3825658480-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH D:\github\BeaconChildrenCenter\resources\views/livewire/parent-crud.blade.php ENDPATH**/ ?>