...
} elseif ($_instance->childHasBeenRendered('399wchg')) {
    $componentId = $_instance->getRenderedChildComponentId('399wchg');
    $componentTag = $_instance->getRenderedChildComponentTagName('399wchg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('399wchg');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('399wchg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
