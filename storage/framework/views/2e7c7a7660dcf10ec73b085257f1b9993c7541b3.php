                ...
                <form id="therapy-form" class="space-y-4" onsubmit="handleSubmit(event)">
                    ...
                    <div class="mt-4">
                        <div id="goals" class="tabs-content space-y-4 p-4">
                            ...
                            and wellness']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-4">
                        ...
                        <div id="individualPlanAndStrategies" class="tabs-content space-y-4 p-4 hidden">
                            <?php $__currentLoopData = ['Therapy frequency and Duration', 'Therapy Setting', 'Meal Plan', 'Behaviour Management', 'Other Support services', 'Evaluate and Adapt']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($category); ?></label>
                                    <textarea 
                                    class="w-full h-20 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 resize-none"
