...
} elseif ($_instance->childHasBeenRendered('1zzoqPm')) {
    $componentId = $_instance->getRenderedChildComponentId('1zzoqPm');
    $componentTag = $_instance->getRenderedChildComponentTagName('1zzoqPm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1zzoqPm');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('1zzoqPm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('emEZmya')) {
    $componentId = $_instance->getRenderedChildComponentId('emEZmya');
    $componentTag = $_instance->getRenderedChildComponentTagName('emEZmya');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('emEZmya');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('emEZmya', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\sharo\Downloads\Beacon's\BeaconChildrenCenter\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>