...
} elseif ($_instance->childHasBeenRendered('KZspofs')) {
    $componentId = $_instance->getRenderedChildComponentId('KZspofs');
    $componentTag = $_instance->getRenderedChildComponentTagName('KZspofs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KZspofs');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('KZspofs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('GW1OeV0')) {
    $componentId = $_instance->getRenderedChildComponentId('GW1OeV0');
    $componentTag = $_instance->getRenderedChildComponentTagName('GW1OeV0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GW1OeV0');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('GW1OeV0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\tobik\OneDrive\Documents\GitHub\BeaconChildrenCenter\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>