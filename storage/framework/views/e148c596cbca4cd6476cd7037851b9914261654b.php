...
} elseif ($_instance->childHasBeenRendered('HOFCo9O')) {
    $componentId = $_instance->getRenderedChildComponentId('HOFCo9O');
    $componentTag = $_instance->getRenderedChildComponentTagName('HOFCo9O');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HOFCo9O');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('HOFCo9O', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\tobik\OneDrive\Documents\GitHub\BeaconChildrenCenter\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>