...
} elseif ($_instance->childHasBeenRendered('5BySCzh')) {
    $componentId = $_instance->getRenderedChildComponentId('5BySCzh');
    $componentTag = $_instance->getRenderedChildComponentTagName('5BySCzh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5BySCzh');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('5BySCzh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('W6h5SY3')) {
    $componentId = $_instance->getRenderedChildComponentId('W6h5SY3');
    $componentTag = $_instance->getRenderedChildComponentTagName('W6h5SY3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('W6h5SY3');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('W6h5SY3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
