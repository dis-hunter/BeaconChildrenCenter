...
} elseif ($_instance->childHasBeenRendered('nyXmTto')) {
    $componentId = $_instance->getRenderedChildComponentId('nyXmTto');
    $componentTag = $_instance->getRenderedChildComponentTagName('nyXmTto');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nyXmTto');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('nyXmTto', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('P1JUgsH')) {
    $componentId = $_instance->getRenderedChildComponentId('P1JUgsH');
    $componentTag = $_instance->getRenderedChildComponentTagName('P1JUgsH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('P1JUgsH');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('P1JUgsH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
