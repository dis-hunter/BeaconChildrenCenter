...
<body class="m-0 font-sans bg-gray-50">
  <!-- Sidebar -->
  <div class="h-screen w-64 fixed left-0 top-0 bg-gradient-to-b from-sky-100 to-sky-200 overflow-x-hidden pt-5 transition-all duration-300 hover:w-72 border-r border-sky-300 shadow-lg">
  ...
  <div class="fixed right-5 top-20 bg-white rounded-lg shadow-lg overflow-hidden" id="floatingMenu">
    ...
    <a href="#generalExam" class="block px-4 py-3 text-gray-700 border-b border-gray-100 transition-all duration-300 hover:bg-sky-50 hover:text-blue-600">Psychotherapy Assessment</a>
    <div id="generalExam"></div>
    <a href="#Examination" class="block px-4 py-3 text-gray-700 border-b border-gray-100 transition-all duration-300 hover:bg-sky-50 hover:text-blue-600">Psychotherapy Goals</a>
    <div id="Examination"></div>
    <a href="#devAssesment" class="block px-4 py-3 text-gray-700 border-b border-gray-100 transition-all duration-300 hover:bg-sky-50 hover:text-blue-600">Psychotherapy Session</a>
    <div id="devAssesment"></div>
    <a href="#diagnosis" class="block px-4 py-3 text-gray-700 border-b border-gray-100 transition-all duration-300 hover:bg-sky-50 hover:text-blue-600">Psychotherapy Individualized Therapy Plan</a>
...
</html><?php /**PATH C:\Users\sharo\Desktop\Today\htdocs\BeaconChildrenCenter-4\resources\views/therapists/psychotherapyDashboard.blade.php ENDPATH**/ ?>