...
// ends here
    ...
    <div class="grid grid-cols-3 gap-6">
        <div class="space-y-2">
            ...
            <input type="text" id="firstName" name="firstName" value="<?php echo e($fullName); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
    </div>
    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="space-y-2">
            ...
            <input type="text" id="genderAge" name="genderAge" value="<?php echo e($gender); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
        <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700" for="hnu">HNU</label>
            <input type="text" id="hnu" name="hnu" value="<?php echo e($child->id); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
    </div>
    ...
    <div class="grid grid-cols-3 gap-6">
        <div class="space-y-2">
            ...
            <input type="text" id="mothersName" name="mothersName" value="<?php echo e($parents['femaleParent']['fullname'] ?? 'N/A'); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
        <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700" for="motherTel">Tel</label>
            <input type="tel" id="motherTel" name="motherTel" value="<?php echo e($parents['femaleParent']['telephone'] ?? 'N/A'); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
        <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700" for="motherEmail">Email</label>
            <input type="email" id="motherEmail" name="motherEmail"value="<?php echo e($parents['femaleParent']['email'] ?? 'N/A'); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
    </div>
    ...
    <div class="grid grid-cols-3 gap-6">
        <div class="space-y-2">
            ...
            <input type="text" id="fathersName" name="fathersName" value="<?php echo e($parents['maleParent']['fullname'] ?? 'N/A'); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
        <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700" for="fatherTel">Tel</label>
            <input type="tel" id="fatherTel" name="fatherTel" value="<?php echo e($parents['maleParent']['telephone'] ?? 'N/A'); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
        <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700" for="fatherEmail">Email</label>
            <input type="email" id="fatherEmail" name="fatherEmail" value="<?php echo e($parents['maleParent']['email'] ?? 'N/A'); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" readonly>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\sharo\Downloads\Beacon's\BeaconChildrenCenter-2\resources\views/therapists/occupationaltherapyDashboard.blade.php ENDPATH**/ ?>