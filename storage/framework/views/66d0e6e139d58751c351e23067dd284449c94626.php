...
} elseif ($_instance->childHasBeenRendered('CqUWI3w')) {
    $componentId = $_instance->getRenderedChildComponentId('CqUWI3w');
    $componentTag = $_instance->getRenderedChildComponentTagName('CqUWI3w');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CqUWI3w');
} else {
    $response = \Livewire\Livewire::mount('global-search');
    $html = $response->html();
    $_instance->logRenderedChild('CqUWI3w', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div> 
<div class="ml-auto">
