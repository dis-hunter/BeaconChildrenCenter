...
} elseif ($_instance->childHasBeenRendered('ulqX1hJ')) {
    $componentId = $_instance->getRenderedChildComponentId('ulqX1hJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('ulqX1hJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ulqX1hJ');
} else {
    $response = \Livewire\Livewire::mount('global-search');
    $html = $response->html();
    $_instance->logRenderedChild('ulqX1hJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div> 
<div class="ml-auto">
...
<?php /**PATH C:\Users\tobik\OneDrive\Documents\GitHub\BeaconChildrenCenter\resources\views/reception/header.blade.php ENDPATH**/ ?>