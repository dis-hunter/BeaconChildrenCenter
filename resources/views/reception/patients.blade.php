        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted">Birth Certificate: {{$child->birth_cert}}</p></div>
                    <p><strong>Last Visited:</strong> {{$last_visit->visit_date ?? 'First Time'}}, {{$last_visit?->visitType?->first()?->visit_type ?? 'N/A'}}</p>
                    {{-- <div>
