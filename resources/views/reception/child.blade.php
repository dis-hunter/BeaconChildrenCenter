...
@section('content')
    ...
    <div class="container mt-5">
        <div x-data="{
            showForm:{!! json_encode(session('showForm', false)) !!},
            isLoading:false
            }">
            ...
            <form action="/guardians" method="post" class="bg-light p-4 rounded shadow-sm" x-show="showForm"
                  x-transition @submit.prevent="isLoading = true; $event.target.submit()">
                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="insurance" name="insurance" value="{{ old('insurance') }}"
                               class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label for="referer" class="form-label">Referer</label>
                        <input type="text" id="referer" name="referer" value="{{ old('referer') }}"
                               class="form-control">
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="firstname2" name="firstname2" value="{{ old('firstname2') }}"
                               class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label for="middlename2" class="form-label">Middle Name</label>
                        <input type="text" id="middlename2" name="middlename2" value="{{ old('middlename2') }}"
                               class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label for="lastname2" class="form-label">Surname</label>
                        <input type="text" id="lastname2" name="lastname2" value="{{ old('lastname2') }}"
                               class="form-control">
                    </div>
                </div>
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" id="birth_cert" name="birth_cert" value="{{ old('birth_cert') }}"
                               class="form-control">
                    </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary w-100" :disabled="isLoading">
                            ...
                            <span x-show="isLoading" class="spinner-border spinner-border-sm" role="status"></span></button>
                    </div>
                </div>
            </form>
        </div>
