        ...
        <section 
            ...
            x-data="{ 
                ...
                renderCharts() {
                    ...
                    this.charts.servicesChart = new Chart(servicesChart, {
                        type: 'bar',
                        data: {
                    ...
                    this.charts.dailyRevenueChart = new Chart(dailyChart, {
                        type: 'line',
                        data: {
                    ...
                    this.charts.paidInvoicesChart = new Chart(paidInvoicesChart, {
                        type: 'line',
                        data: {
        ...
        >
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                <div class="bg-gray-50 p-4 rounded-lg shadow">
                    <h3 style="color:black;" class="text-lg font-medium text-gray-900">Total Revenue</h3>
                    <p style="color:black;" class="text-2xl text-gray-900" x-text="formatCurrency(reportData?.summary?.total_revenue || 0)"></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg shadow">
                    <h3 style="color:black;" class="text-lg font-medium text-gray-900">Normal Payments</h3>
                    <p style="color:black;" class="text-2xl text-gray-900" x-text="formatCurrency(reportData?.summary?.normal_payment || 0)"></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg shadow">
                    <h3 style="color:black;" class="text-lg font-medium text-gray-900">Sponsored Payments</h3>
                    <p style="color:black;" class="text-2xl text-gray-900" x-text="formatCurrency(reportData?.summary?.sponsored_payment || 0)"></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg shadow">
                    <h3 style="color:black;" class="text-lg font-medium text-gray-900">Paid Invoices</h3>
                    <p style="color:black;" class="text-2xl text-gray-900" x-text="formatCurrency(reportData?.summary?.paid_invoices_total || 0)"></p>
                </div>
            </div>
