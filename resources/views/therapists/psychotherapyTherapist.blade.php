            ...
            <div class="p-4">
                <form id="therapy-form" class="space-y-4" onsubmit="handleSubmit(event)">
                    ...
                    <div id="therapyAssesment" class="tabs-content space-y-4 p-4 hidden">
                            @foreach(['Psychologic issues', 'Emotional issues', 'Behavioural issuess', 'Psychosocial history', 'Risk factors','Resilience factors'] as $category)
                                <div class="mb-4">
                    ...
                    <div class="mt-4">
                        <div id="goals" class="tabs-content space-y-4 p-4">
                            @foreach(['Anxiety Management','Stress Management','Motivation'] as $category)
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">{{ $category }}</label>
                                    <textarea 
                                        class="w-full h-20 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 resize-none"
                        ...
                        <div id="individualPlanAndStrategies" class="tabs-content space-y-4 p-4 hidden">
                            @foreach(['Therapy frequency and Duration', 'Therapy Setting', 'Intervention techniques', 'Home Assesment', 'Monitor Progress of Therapy', 'Adaptations'] as $category)
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">{{ $category }}</label>
                                    <textarea 
                                    class="w-full h-20 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 resize-none"
                        ...
                        <div id="session" class="tabs-content space-y-4 p-4 hidden">
                            @foreach(['Cognitive behaviour therapy (CBT)', 'Psychodynamic therapy', 'Solution focused therapy'] as $category)
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">{{ $category }}</label>
                                    <textarea 
                                        class="w-full h-20 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 resize-none"
