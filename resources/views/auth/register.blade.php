                        ...
                        <div class="card rounded-3 text-black">
                            <div class="card-body p-md-5 mx-md-4">
                                ...
                                <div class="d-flex justify-content-center">
                                    <img src="{{ asset('images/logo.jpg') }}" style="width: 180px;" alt="logo">
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <select class="form-select" name="gender" id="gender">
                                                    <option disabled {{ old('gender') === null ? 'selected' : '' }}>
                                                    </option>
                                        ...
                                        <div class="col-md-6" id="specs" style="display: none">
                                            <div class="form-floating mb-4">
                                                <select class="form-select" name="specialization" id="specialization">
                                                    <option disabled
                                                        {{ old('specialization') === null ? 'selected' : '' }}></option>
                                                    @foreach ($specializations as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ old('specialization') === $item->id ? 'selected' : '' }}>
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#role').change(function() {
                                                    if (parseInt($(this).val()) === 2 || parseInt($(this).val()) === 5) {
                                                        $('#specs').show();
                                                    } else {
                                                        $('#specs').hide();
                                                    }
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <input type="text" id="telephone" name="telephone" class="form-control"
                                                    placeholder="Phone Number" value="{{ old('telephone') }}" required />
