...
class TherapistController extends Controller
{
    ...
    public function showDashboard()
    {
        $visits = DB::table('visits')
            ...
            ->select('visits.id as visit_id', 'visits.visit_date','visits.created_at', 'children.id as child_id', 'children.registration_number','children.fullname', 'children.dob', 'staff.id as staff_id', 'staff.specialization_id')
